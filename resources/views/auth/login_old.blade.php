  ...
  <div class="user_options-container">
    ...
    <div class="user_options-forms" id="user_options-forms">
      ...
      <div class="user_forms-signup">
        <h2 class="forms_title text-center">Sign Up</h2>
        ...
        <form method="POST" action="/">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" col="4"></textarea>
                        ...
                        <div class="row mb-3">
                            <label for="pincode" class="col-md-4 col-form-label text-md-end">{{ __('Gender') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="file" class="form-control @error('dob') is-invalid @enderror" name="photo" value="{{ old('photo') }}" >
