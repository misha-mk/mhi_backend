                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body p-12">
                            <form method="POST" action="{{ route('admin.patient.savepatient') }}" accept-charset="UTF-8" id="" enctype="multipart/form-data">
                            @csrf <!-- {{ csrf_field() }} -->
                                ...
                                <div class="row gx-10 ">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" required="" tabindex="2" name="lname" type="text"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="bg-white patientBirthDate form-control flatpickr-input" id="mhiBirthDate" tabindex="4" name="dob" type="date"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mobile-overlapping  mb-5">
                                            ...
                                            <input class="form-control" required min="10" tabindex="5" name="phone" type="number" value="" id="phonenumber" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <select class="form-select select2-hidden-accessible" id="mhipBloodGroup" data-control="select2" tabindex="8" name="bloodgroup" data-select2-id="select2-data-patientBloodGroup" aria-hidden="true" required>
                                                <option selected="selected" value="" data-select2-id="select2-data-171-hn1b">Select Blood Group</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" required="" min="6" max="10" tabindex="10" name="password" type="password" value="" id="password" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" required="" min="6" max="10" tabindex="11" name="password_confirmation" type="password" value="" id="password_confirmation" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-3 mb-5 customer_records">
                                    ...
                                    <div class="form-group col-sm-6 mb-5">
                                        ...
                                        <input class="form-control" id="emer_name" name="emer_name" type="text" required>
                                    </div>

                                    <div class="form-group col-sm-6 mb-5">
                                        <label for="emer_contact_nu" class="form-label labelcolor">Phone Number:</label>
                                        <input class="form-control" id="emer_contact_nu" min="10" name="emer_contact_nu" type="number" required>
                                    </div>
                                </div>
