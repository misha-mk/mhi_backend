    ...
    <div class="content d-flex flex-column flex-column-fluid pt-7">
        <div class="container-fluid">
            <div class="d-md-flex align-items-center justify-content-between mb-7">
                <h3 class="mb-0" style="color: black; font-weight:700;"> Testimonials
                </h3>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body p-12">
                            <form method="POST" action="{{ route('admin.hospital.savetestimonial') }}" accept-charset="UTF-8" id="" enctype="multipart/form-data">
                            @csrf <!-- {{ csrf_field() }} -->
                                ...
                                <div class="row gx-10 ">
                                    <div class="col-md-12 mb-3">
                                        <h5 class="labelcolor" style="font-weight:700;">Testimonials Details</h5>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            <label for="first_name" class="form-label labelcolor">Name:</label>
                                            <input class="form-control" required="required" tabindex="1" name="name" type="text" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            <label for="last_name" class="form-label labelcolor">Email:</label>
                                            
                                            <input class="form-control"  tabindex="2" name="email" type="email">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            <label for="last_name" class="form-label labelcolor">Review:</label>
                                            
                                            <input class="form-control"  tabindex="2" name="review" type="text" required="required">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            <label for="last_name" class="form-label labelcolor">Title:</label>
                                            
                                            <input class="form-control"  tabindex="2" name="title" type="text" required="required">
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            <label for="dob" class="form-label labelcolor">Ratings:</label>
                                            <input class="bg-white patientBirthDate form-control flatpickr-input"  name="rating" type="number"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                    ...
                                    <div class="form-group col-md-12 mb-5" style="margin-top: 20px;">
                                        <div class="row2" io-image-input="true">
                                            <label for="image" class="form-label labelcolor">Image:</label>
                                            <div class="d-block">
