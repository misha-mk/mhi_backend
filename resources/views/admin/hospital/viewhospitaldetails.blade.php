...
.tagss1 
{
    ...
    <div class="content d-flex flex-column flex-column-fluid pt-7">
        <div class="container-fluid">
            <div class="d-md-flex align-items-center justify-content-between mb-7 ">
                <h3 class="mb-0" style="color: black; font-weight:700;"> Hospital Details
                </h3>
    ...
    <div class="container-fuild hospitaldetailshead">
        <div class="row hospitaldetailsheadrow">
            ...
            <h4 style="color: blue !important;" id="fullname"> {{$hospitaldetails[0]->name}}</h4>
                @if($hospitaldetails[0]->image)
                <img src="{{ asset('images/'.$hospitaldetails[0]->image) }}" alt="" class="user-img object-contain" width="700px" height="350px">
                @else
        ...
        <div class="row hospitaldetailsheadrow text-center" style="margin-top: 20px;">
            <div class="col-md-12" style="color: black;">
                <h4>{{$hospitaldetails[0]->contact}}</h4>
                <h4> {{$hospitaldetails[0]->email}} </h4>
                <p style="padding-left:15px;"> {{$hospitaldetails[0]->address}} </p> 
            </div>
        </div>
        ...
        <div class="hospitaldetailsbodysection">
            <div class="mt-7 overflow-hidden" >
                <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap text-center">
                    ...
                    <a class= "p-0 btn btn-primary tagss1 mb-3" href="{{ route('admin.doctor.addDoctor', ['id' => $hospitaldetails[0]->h_id,'type' => 'Hospital']) }}">Add Doctor</a>
                </ul>
                            ...
                            <div class="card-body  border-top p-9">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                        ...
                                        <p>
                                            <span class="fs-5 text-gray-800">{{$hospitaldetails[0]->number_bed}}</span>
                                        </p>
                                    </div>
                                    <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                        <label for="name" class="pb-2 fs-5 text-gray-600">Facilities</label>
                                        <p>
                                            <span class="fs-5 text-gray-800">{{$hospitaldetails[0]->facilities}}</span>
                                        </p>
                                    </div>
                                    <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                        <label for="name" class="pb-2 fs-5 text-gray-600">Operation Theatre (OT`S)</label>
                                        <p>
                                            <span class="fs-5 text-gray-800">{{$hospitaldetails[0]->ots}}</span>
                                        </p>
                                    </div>
                                    <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                        <label for="name" class="pb-2 fs-5 text-gray-600">Benifits</label>
                                        <p>
                                            <span class="fs-5 text-gray-800">{{$hospitaldetails[0]->benifits}}</span>
                                        </p>
                                    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                {?>
                                     ...
                                     <tr>
                                        ...
                                        <td>{{$d->status}}</td>
                                        <td>
                                        <a href="{{ route('admin.doctor.editDoctor', ['id' => $hospitaldetails[0]->h_id,'d_id' => $d->d_id,'type' =>'Hospital']) }}" style="margin-left:10px;margin-top:35px;"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        <a href="{{ route('admin.doctor.editDoctor', ['id' => $hospitaldetails[0]->h_id,'d_id' => $d->d_id,'type' =>'Hospital']) }}" style="margin-left:10px;margin-top:35px;"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        <a href="{{ route('admin.doctor.editDoctor', ['id' => $hospitaldetails[0]->h_id,'d_id' => $d->d_id,'type' =>'Hospital']) }}" style="margin-left:10px;margin-top:35px;"><i class="fa fa-ban" aria-hidden="true"></i></a>
