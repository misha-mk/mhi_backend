    ...
    <div class="content d-flex flex-column flex-column-fluid pt-7">
        <div class="container-fluid">
            <div class="d-md-flex align-items-center justify-content-between mb-7">
                <h3 class="mb-0" style="color: black; font-weight:700;"> Update Clinic
                </h3>
                <a href="{{ route('admin.hospital.addtestimonial', ['id' => $clinicdetails[0]->c_id])}}" class="btn btn-outline-primary">Testimonial</a>
                <a href="{{ route('admin.hospital.addfaq', ['id' => $clinicdetails[0]->c_id]) }}" class="btn btn-outline-primary">FAQ</a>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body p-12">
                            <form method="POST" action="{{ route('admin.hospital.saveupdatedclinicinfo') }}" accept-charset="UTF-8" id="" enctype="multipart/form-data">
                            @csrf <!-- {{ csrf_field() }} -->
                                <div class="alert alert-danger d-none" id="patientErrorBox"></div>
                                <input class="form-control"  tabindex="1" name="c_id" type="hidden" value="{{$clinicdetails[0]->c_id}}">
                                <div class="row gx-10 ">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" required="required" value="{{$clinicdetails[0]->name}}" tabindex="1" name="name" type="text" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control"  tabindex="2" name="website" type="text" value="{{$clinicdetails[0]->website}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control"  tabindex="2" name="fees" type="text" required="required" value="{{$clinicdetails[0]->fees}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            <label for="dob" class="form-label labelcolor">Number Of Bed:</label>
                                            <input class="bg-white patientBirthDate form-control flatpickr-input" id="mhiBirthDate" tabindex="4" name="number_bed" type="number"  required value="{{$clinicdetails[0]->number_bed}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <label for="status" class="form-label labelcolor">Status:</label>
                                            ...
                                            <select class="form-select select2-hidden-accessible" id="mhigender" data-control="select2" tabindex="6" name="status" data-select2-id="select2-data-patientBloodGroup" aria-hidden="true" required>
                                                <option selected="selected" value="{{$clinicdetails[0]->status}}" data-select2-id="select2-data-171-hn1b">{{$clinicdetails[0]->status}}</option>
                                    ...
                                    <div class="form-group col-md-4 mb-5">
                                        <div class="row2" io-image-input="true">
                                            ...
                                            <div class="d-block">
                                                <input class="form-control" name="ots" type="text" id="ot" value="{{$clinicdetails[0]->ots}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-5 ml-4" style="margin-top: 20px;">
                                            ...
                                            <select class="form-select select2-hidden-accessible"  data-control="select2" tabindex="6" name="emergencyward" data-select2-id="select2-data-patientBloodGroup" aria-hidden="true" required>
                                                <option selected="selected" value="{{$clinicdetails[0]->emergencyward}}" data-select2-id="select2-data-171-hn1b">{{$clinicdetails[0]->emergencyward}}</option>
                                ...
                                <div class="row mt-3 mb-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" name="ownername" type="text" required value="{{$clinicdetails[0]->ownername}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" maxlength="10" minlength="10" name="ownerphone" type="number"  required value="{{$clinicdetails[0]->ownerphone}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            <label for="zip" class="form-label labelcolor">Email:</label>
                                            <input class="form-control" name="owneremail" type="email"  required value="{{$clinicdetails[0]->owneremail}}">
                                        </div>
                                    </div>
                                </div>
                                <hr style="margin: -12px !important;">
                                <div class="row mt-3 mb-5">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" name="address" type="text" id="address" required value="{{$clinicdetails[0]->address}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" maxlength="6" minlength="6" name="pincode" type="text" id="pincode" required value="{{$clinicdetails[0]->pincode}}">
                                        </div>
                                    </div>
                                </div>
                                <hr style="margin: -12px !important;">
                                <div class="row mt-3 mb-5 customer_records">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" required="required" name="email" type="email" id="email" value="{{$clinicdetails[0]->email}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mobile-overlapping  mb-5">
                                            ...
                                            <input class="form-control" required min="10" tabindex="5" name="contact" type="number" id="" required value="{{$clinicdetails[0]->contact}}">
                                        </div>
                                    </div>
                                </div>
                                <hr style="margin: -12px !important;">
                                <div class="row mt-3 mb-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" name="rname" type="text"  required value="{{$clinicdetails[0]->rname}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            ...
                                            <select class="form-select select2-hidden-accessible"  data-control="select2" name="rtype" data-select2-id="select2-data-patientBloodGroup" aria-hidden="true" required>
                                                <option selected="selected" value="{{$clinicdetails[0]->rtype}}" data-select2-id="select2-data-171-hn1b">{{$clinicdetails[0]->rtype}}</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control"  name="cmonumber" type="text" required value="{{$clinicdetails[0]->cmonumber}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            <label for="zip" class="form-label labelcolor">NABH:</label>
                                            <input class="form-control" name="nabh" type="text"  required value="{{$clinicdetails[0]->nabh}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            <label for="zip" class="form-label labelcolor">USP:</label>
                                            <input class="form-control"  name="usp" type="text"  required value="{{$clinicdetails[0]->usp}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                            <label for="zip" class="form-label labelcolor">Established Date:</label>
                                            <input class="form-control" name="rdate" type="date" required value="{{$clinicdetails[0]->rdate}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-5">
                                ...
                                <div class="row mt-3 mb-5">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" name="bankname" type="text" required value="{{$clinicdetails[0]->bankname}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control"  name="acnumber" type="text"  required value="{{$clinicdetails[0]->acnumber}}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <select class="form-select select2-hidden-accessible"  data-control="select2" name="atype" data-select2-id="select2-data-patientBloodGroup" aria-hidden="true" required>
                                                <option selected="selected" value="{{$clinicdetails[0]->atype}}" data-select2-id="select2-data-171-hn1b">{{$clinicdetails[0]->atype}}</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control"  name="acountholdername" type="text" required value="{{$clinicdetails[0]->acountholdername}}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group mb-5">
                                            <label for="zip" class="form-label labelcolor">IFSC CODE:</label>
                                            <input class="form-control"  name="ifsc" type="text"  required value="{{$clinicdetails[0]->ifsc}}">
                                        </div>
                                    </div>
                                </div>
                                <hr style="margin: -12px !important;">
                                ...
                                <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="editor1" required>{{$clinicdetails[0]->aboutUs}}</textarea>
                                    </div>
