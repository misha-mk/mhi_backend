    ...
    <div class="content d-flex flex-column flex-column-fluid pt-7">
        <div class="container-fluid">
            <div class="d-md-flex align-items-center justify-content-between mb-7">
                <h3 class="mb-0" style="color: black; font-weight:700;"> New Hospital
                </h3>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body p-12">
                            <form method="POST" action="{{ route('admin.hospital.savehospitaldetails') }}" accept-charset="UTF-8" id="" enctype="multipart/form-data">
                            @csrf <!-- {{ csrf_field() }} -->
