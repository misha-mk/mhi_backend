                ...
                <table class="table table-striped datatable datatable-User">
                    ...
                    <tbody class="">
                        ...
                        <td></td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="image image-circle image-mini me-3">
                                        <a href="{{ route('admin.doctor.viewparticulardoctor', ['id' => $p->d_id]) }}">
                                           
                                                @if($p->photo)
                                                <span id="profileImage"></span>
                                                @else
                                                <img src="" alt="" class="user-img rounded-circle object-contain" height="35" width="35">
                                                @endif
                                            
                                        </a>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('admin.doctor.viewparticulardoctor', ['id' => $p->d_id]) }}" class="text-decoration-none mb-1" id="fullName"> {{$p->fname}}  {{$p->lname}}</a>
                                        <span>{{$p->email}}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                            <a href="{{ route('admin.doctor.viewparticulardoctor', ['id' => $p->d_id]) }}" style="margin-left:10px;margin-top:35px;"><i class="fa fa-eye" aria-hidden="true"></i></a>
