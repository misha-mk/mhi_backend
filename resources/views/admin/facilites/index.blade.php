        ...
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                ...
                <a href="{{ route('admin.facilites.addfacilites') }}" class="btn btn-primary">
                    ...
                    <span class="text">{{ __('New Facilites') }}</span>
                </a>
                ...
                <table class="table table-striped datatable datatable-User">
                    ...
                    <tbody class="">
                        ...
                        <td></td>
                            ...
                            <td>
                            <a href="{{ route('admin.facilites.deletefacilites', ['id' => $p->facilites_id]) }}" style="margin-left:10px;margin-top:35px;"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            <a href="{{ route('admin.facilites.editfacilites', ['id' => $p->facilites_id]) }}" style="margin-left:10px;margin-top:35px;"><i class="fa fa-edit" aria-hidden="true"></i></a>
