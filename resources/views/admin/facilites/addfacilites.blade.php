                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body p-12">
                            <form method="POST" action="{{ route('admin.facilites.savefacilitesdata') }}" accept-charset="UTF-8" id="" enctype="multipart/form-data">
                            @csrf <!-- {{ csrf_field() }} -->
                                ...
                                <div class="row gx-10 ">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-5">
                                            ...
                                            <input class="form-control" required="required" tabindex="1" name="facilites_name" type="text" >
                                        </div>
                                    </div>
