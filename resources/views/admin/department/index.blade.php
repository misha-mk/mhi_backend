    ...
    <div class="card">
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                ...
                <a href="{{ route('admin.department.adddepartment') }}" class="btn btn-primary">
                    <span class="icon text-white-50">
                        <i class="fa fa-plus"></i>
                    </span>
                    <span class="text">{{ __('New Department') }}</span>
                </a>
                ...
                <table class="table table-striped datatable datatable-User">
                    ...
                    <tbody class="">
                        ...
                        <td></td>
                            ...
                            <td>
                            <a href="{{ route('admin.department.deletedepartment', ['id' => $p->department_id]) }}" style="margin-left:10px;margin-top:35px;"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            <a href="{{ route('admin.department.editdepartment', ['id' => $p->department_id]) }}" style="margin-left:10px;margin-top:35px;"><i class="fa fa-edit" aria-hidden="true"></i></a>
